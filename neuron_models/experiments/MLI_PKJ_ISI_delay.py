...
if __name__ == "__main__":
    ...
    out_dir = '/home/bill/research/data/neuron_models/molecular_layer/MLI_PKJ_ISI_delay/%s/' % datetime.datetime.now().isoformat()
    os.makedirs(out_dir)
    
    # write parameters to file
    with open(out_dir+'parameters.txt','w') as outf:
        outf.write('\t'.join(['k','theta','T','g_inh','delay','dt'])+'\n')
